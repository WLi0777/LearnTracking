...
def create_folders_yolo(video_folder="ori_video", frames_folder="frames_labeling", labeled_folder="yolo_folder", total_frames="frames_labeling/total_video_frames"):
    """
    Create necessary folders to avoid duplicates.
